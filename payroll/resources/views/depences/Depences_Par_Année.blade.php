...
<div class="row">
    ...
    <form action="{{Route('depence_annuelles')}}" method="GET">
        <div class="col-6 recherche">
            <div class="from_to" style="color: yellow">Date_from----------------->Date_to :</div>
...
<h3 style="color: white">Depences par année :</h3>
...
{{-- <div class="row">
    <div class="col-4 totale">
        <h4>Totale Depencé Cette Année: <div class="cercle"><div class="total_style">{{$totale_par_année}} MAD</div> </div> </h4>
    </div>
